...
const cat = {       // using names of variables istead of key and value
	catName,
	catAge,
}
...
function User(name, age) {      //consturctor
	this.name = name
	this.age = age
}
...
User.prototype.hello = function() {       //prototype
